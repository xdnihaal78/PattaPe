  ...
  if (!diagnosis) {
    return (
      <div className="w-full max-w-md mx-auto px-4 py-12 text-center space-y-3">
        <h2 className="text-xl font-black text-slate-800">No Diagnosis Found</h2>
        <p className="text-sm text-slate-600 font-semibold">Please upload a leaf photo to analyze first.</p>
        <button
          onClick={() => navigate('/')}
          ...
          <div className="bg-white w-full max-w-md rounded-2xl p-5 border-2 border-red-700 shadow-2xl space-y-4 animate-in fade-in slide-in-from-bottom-4">
            ...
            <div className="flex items-center justify-between border-b border-slate-200 pb-2.5">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-black text-slate-900 m-0">Agri Officer Escalation</h3>
              </div>
              <button 
            ...
            {escalatedTicket ? (
              <div className="bg-emerald-50 border border-emerald-400 rounded-xl p-4 text-center space-y-2.5">
                ...
                <p className="text-sm font-bold text-emerald-900 m-0">
                  Ticket ID: <span className="font-black bg-emerald-200 px-2 py-0.5 rounded">{escalatedTicket}</span>
                </p>
                <p className="text-xs font-semibold text-slate-700 m-0">
                  KVK Officer <span className="font-bold">{officer.name}</span> has received your report. Callback within 2 hours.
                </p>
                <button
                  onClick={() => setShowEscalateModal(false)}
              ...
              <div className="space-y-3">
                ...
                <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-200 space-y-2">
                  ...
                  <div className="text-xs font-medium text-slate-600 pt-2 border-t border-slate-200 space-y-1">
                    ...
                    <p className="flex items-center gap-1.5 m-0">
                      ...
                      <span>Hours: {officer.availableHours}</span>
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <span>Call Kisan Helpline ({officer.kisanHelpline})</span>
                </a>
